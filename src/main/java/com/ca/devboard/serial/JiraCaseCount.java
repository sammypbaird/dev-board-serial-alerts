...
public class JiraCaseCount
{
	private static final Logger LOG = Logger.getLogger(JiraCaseCount.class.getName());
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		while (true)
		{
			...
			{
				Logger.getLogger(JiraCaseCount.class.getName()).log(Level.SEVERE, null, ex);
			}
			Thread.sleep(5000);
		}
	}
